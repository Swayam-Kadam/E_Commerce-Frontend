...
//     inStock: false,
//     isBestSeller: false
//     // Removed isNew since it doesn't exist in your data
//   });
...
//     // Apply additional filters - UPDATED to match your data structure
//     result = result.filter(product => {
...
//         (!filters.inStock || hasStock) &&
//         (!filters.isBestSeller || product.isBestSeller)
//         // Removed isNew filter since it doesn't exist in your data
//       );
//     });
