  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Favorite button */}
        <button 
          className="absolute top-2 right-2 bg-white p-1.5 rounded-full shadow-md hover:bg-red-50 cursor-pointer"
          onClick={()=>handleWishlist(product._id)}
        >
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            className={`h-5 w-5 ${product?.isWishlist ? 'text-red-500 fill-red-500' : 'text-gray-400 hover:text-red-500'}`}
            viewBox="0 0 23 23" 
            stroke="currentColor"
          >
